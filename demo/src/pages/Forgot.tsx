  ...
  return (
    ...
    <form className="forgot-form" onSubmit={handleSubmit}>
      ...
      <input
        ...
        required
      />
        <button type="submit" className="reset-button generic-btn ">Reset Your Password</button>

      <div className="or-divider">
        <span>Or</span>
      </div>

      <button className='generic-btn' onClick={() => navigate('/homepage')}>Be Visitor and Just Look!</button>
      <button  className='generic-btn' onClick={() => navigate('/login')}>Login to Your Account</button>
    </form>
